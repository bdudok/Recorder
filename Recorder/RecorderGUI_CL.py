...
class GUI_main(QtWidgets.QMainWindow):
    def __init__(self, app, cam_port=5555, treadmill_port=5556, title='Recorder',
                 ...
                 closedloop_port=5557, closedloop_host=None):
        super().__init__()
        ...
        self.closedloop_host = closedloop_host
        self.closedloop_port = closedloop_port
        ...
        #closedloop button
        remote_layout = QtWidgets.QVBoxLayout()
        remote_layout.addWidget(QtWidgets.QLabel('Remote start', ))
        chkbox_layout = QtWidgets.QHBoxLayout()
        self.remote_checkbox = QtWidgets.QCheckBox()
        chkbox_layout.addWidget(self.remote_checkbox)
        self.remote_checkbox.setChecked(False)
        remote_layout.addLayout(chkbox_layout)
        self.listen_button = QtWidgets.QPushButton('Listen', )
        remote_layout.addWidget(self.listen_button)
        self.listen_button.clicked.connect(self.listen)
        horizontal_layout.addLayout(remote_layout)
...
if __name__ == '__main__':
    launch_GUI(title='Recorder', baserow_enabled=True, closedloop_host='10.18.5.124')
