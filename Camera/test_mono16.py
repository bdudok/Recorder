...
'''This format is raw 12 bit (instead of 8)'''
class App:
    def __init__(self):
        self.hcam = None
        self.buf = None
...
# the vast majority of callbacks come from nncam.dll/so/dylib internal threads
    ...
    def run(self):
        ...
        self.hcam.put_Option(nncam.NNCAM_OPTION_BITDEPTH, 1)
        ...
        bufsize = nncam.TDIBWIDTHBYTES(width * 16) * height
...
if __name__ == '__main__':
    ...
    arr1 = numpy.frombuffer(d, dtype='uint16').reshape((app.sz[1], app.sz[0]))
